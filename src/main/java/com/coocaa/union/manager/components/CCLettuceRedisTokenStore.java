package com.coocaa.union.manager.components;
...
@Component
public class CCLettuceRedisTokenStore implements TokenStore {
    ...
    public CCLettuceRedisTokenStore(RedisConnectionFactory connectionFactory) {
